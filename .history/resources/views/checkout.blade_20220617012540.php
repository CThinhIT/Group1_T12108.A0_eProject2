...
<style>
  .body{
    background-image: url({{asset('assaets/images/product')}});
  ...
  <div class="head">
    <header>
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a href="#" class="navbar-brand"><img src="../image/282296983_2802424453399898_7668863449483069170_n.png" alt=""></a>
                      ...
                      <div class="card-body">
                        <div class="d-flex justify-content-between">
                          <div class="d-flex flex-row align-items-center">
                            <div>
                              <img
                                src="../image/m185-gallery-1-blue-emea.webp"
